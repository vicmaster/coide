...
export default function PermissionDialog({
  ...
  const preview = inputPreview(permission.tool_name, permission.input)
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className={`w-full mx-4 rounded-2xl border border-white/[0.1] bg-[#141414] shadow-2xl p-5 ${wide ? 'max-w-3xl' : 'max-w-md'}`}>
        ...
        <div className="flex items-center gap-3 mb-4">
          <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-yellow-400/10 font-mono text-sm text-yellow-400/80 flex-shrink-0">
